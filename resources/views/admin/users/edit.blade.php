                ...
                <div class="card shadow-sm border-0 rounded-4">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
                            ...
                            {{-- Name --}}
                            <div
                                class="input-group input-group-outline mt-3 @if (strlen($user->name ?? '') > 0) is-filled @endif">
                            ...
                            {{-- Email --}}
                            <div
                                class="input-group input-group-outline mt-3 @if (strlen($user->email ?? '') > 0) is-filled @endif">
                            ...
                            {{-- Phone --}}
                            <div
                                class="input-group input-group-outline mt-3 @if (strlen($user->phone ?? '') > 0) is-filled @endif">
