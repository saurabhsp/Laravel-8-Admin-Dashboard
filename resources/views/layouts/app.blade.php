<x-layouts.base>
    @if (in_array(request()->route()->getName(),['admin.signup','user.login', 'user.signup','admin.login','dealer.login','static-sign-in', 'static-sign-up', 'register', 'login','password.forgot','reset-password']))
        ...
        @if (in_array(request()->route()->getName(),['admin.login', 'user.signup','user.login','dealer.login','admin.signup','static-sign-in', 'login','password.forgot','reset-password']))
