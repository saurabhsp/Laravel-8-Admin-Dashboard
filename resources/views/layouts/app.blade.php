<x-layouts.base>
    @if (in_array(request()->route()->getName(),['admin.signup','admin.login','static-sign-in', 'static-sign-up', 'register', 'login','password.forgot','reset-password']))
        ...
        @if (in_array(request()->route()->getName(),['admin.login','admin.signup','static-sign-in', 'login','password.forgot','reset-password']))
